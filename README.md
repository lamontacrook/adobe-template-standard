...
* Go to <https://github.com/adobe/adobe-template-standard/releases/latest> and download `adobe-template-standard-{version}.zip`
* Upload `adobe-template-standard-{version}.zip` in AEMaaCS's site creation wizard to create a new site from that template.

## Build locally

Alternatively you can build `adobe-template-standard-{version}.zip` locally.
...
1. The site template ZIP file is now located below the template root: `adobe-template-standard-{version}.zip`.
...
* Commit, build and release latest Site Theme related changes in [Site Theme E2E Repo](https://github.com/adobe/adobe-template-standard-theme-e2e).
